...
class FacilityClassifier:
    ...
    KEYWORD_MAPPINGS = {
        ...
        "Group Home": ["group home", "group care", "group childcare"],
        "School Age Program": [
            "school age",
            "after school",
            "before school",
        ...
        "Preschool": ["preschool", "pre-school", "pre school", "pre-k", "pre k"],
        "Residential": ["residential", "group home", "shelter", "foster"],
    }
    ...
    def classify(
        self, facility_descriptions: List[str], use_cache: bool = True
    ) -> List[Dict[str, Any]]:
        """
    ...
    def classify_single(
        self, facility_description: str, use_cache: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    def _classify_with_llm(self, descriptions: List[str]) -> List[Dict[str, Any]]:
...
- "confidence" should reflect your certainty (1.0 = certain, 0.5 = uncertain)"""
    ...
    def _parse_llm_response(
        self, response: str, original_descriptions: List[str]
    ) -> List[Dict[str, Any]]:
    ...
    def _classify_with_rules(self, descriptions: List[str]) -> List[Dict[str, Any]]:
    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "categories_in_cache": list(
                set(cat for cat, _ in self._classification_cache.values())
            ),
        }
