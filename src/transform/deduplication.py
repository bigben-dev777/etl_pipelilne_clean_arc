...
class DuplicateDetector:
                ...
                if value and not pd.isna(value):
                    ...
                    if value_str in seen_values[col]:
                        ...
                        for cluster_id, indices in clusters.items():
                            ...
                            if (
                                first_value
                                and str(first_value).strip().lower() == value_str
                            ):
    ...
    def _ai_resolve_ambiguous(
        self, df: pd.DataFrame, matches: List[Tuple[int, int, float]]
    ...
    def _build_entity_resolution_prompt(
        self, df: pd.DataFrame, pairs: List[Tuple[int, int, float]]
    ) -> str:
...
[
  ...
  ...
    ...
    def _parse_resolution_response(
        self, response: str, pairs: List[Tuple[int, int, float]]
    ) -> List[Tuple[int, int, float]]:
